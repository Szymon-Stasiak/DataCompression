...
//    }
//
//    boolean checkBuildTree(HuffmanTreeNode node) {
//        if (node == null) {
//            return true;
//        }
...
//    }
//
//    boolean checkCodes(HuffmanTreeNode node) {
//        if (node == null) {
//            return true;
//        }
//        if (node.getLeft() == null && node.getRight() == null && node.getWordNode().getCode() == null) {
//            fail("Code is null");
//        }
//        if (node.getLeft() != null) {
